    ...
    <body>
        <style> 
            *{
            ...
            .hai{
                width: 100%;
                /* background: linear-gradient(to top, rgba(0,0,0,0)50%, rgba(0,0,0,0)50%),url("../images/.jpg"); */
                    ...
                    <div>
                        <table class="content-table">
                            ...
                            <tr  class="active-row">
                                ...
                                <td><button type="submit" class="but" name="approve"><a href="adminreturn.php?id=<?php echo $res['BIKE_ID']?>&bookid=<?php echo $res['BOOK_ID']?>">RETURNED</a></button></td>
                            </tr>
                            <?php } ?>
                            </tbody>
                    </table>
