...
<!--- Main Contain start --->
    ...
    ?>
          ...
          <!-- <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="images/BMW.webp" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>BMW</h3>
                <div class="rent-price">
                  <strong>₹1100</strong><span class="mx-1">/</span>day
                </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="images/Honda.jpeg" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Honda</h3>
                <div class="rent-price">
                  <strong>₹1200</strong><span class="mx-1">/</span>day
                </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="images/Apache.webp" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Apache</h3>
                <div class="rent-price">
                  <strong>₹1300</strong><span class="mx-1">/</span>day
                </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="images/Ducati.webp" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Ducati</h3>
                <div class="rent-price">
                  <strong>₹1400</strong><span class="mx-1">/</span>day
                </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            ...
            <div class="listing d-block  align-items-stretch">
              <div class="listing-img h-100 mr-4">
                <img src="images/Kawasaki.png" alt="Image" class="img-fluid">
              </div>
              <div class="listing-contents h-100">
                <h3>Kawasaki</h3>
                <div class="rent-price">
                  <strong>₹1500</strong><span class="mx-1">/</span>day
                </div>
