    ...
    <div class="site-section bg-light" id="contact-section">
      <div class="container">
        ...
        <div class="col-7 text-center mb-5">
          <h2>Contact Us Or Use This Form To Rent A Bike</h2>
        </div>
      </div>
        <div class="row">
            ...
            <div class="bg-white p-3 p-md-5">
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  ...
                  <span>ZOOM RIDES COMPANY,<br>opp. Westgate,<br>Ahmedabad, Gujarat<br>380051</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+91 079 4942 290</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Email:</span><span>info@zoomrides.com</span></li>
              </ul>
            </div>
          </div>
        </div>
