...
<?php
    ...
    $sql3="select * from bikes where BIKE_ID='$bike_id'";
    $name3 = mysqli_query($con,$sql3);
    $rows3=mysqli_fetch_assoc($name3);
?>
   <ul><li> <button  class="utton"><a href="index.php">Go to Home</a></button></li><li class="name">HELLO! <?php echo $rows2['FNAME']." ".$rows2['LNAME']?></li>

</ul>
    <div class="box">
         <div class="content">
             <h1>BIKE NAME : <?php echo $rows3['BIKE_NAME']?></h1><br>
