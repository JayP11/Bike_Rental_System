      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0 order-lg-2">
            <img src="images/Ducati.webp" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-lg-4 mr-auto">
            <h2>ZOOM RIDES COMPANY</h2>
            <p>Zoom bikes is here to redefine the way you travel! Rent a bike on an daily, weekly or even monthly basis. We also have long term leasing solutions for businesses who are into last mile delivery through two wheelers..</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
              ...
              <div class="post-entry-1-contents">
                ...
                <h2>Talaviya Anand</h2>
                <p>Founder Of ZOOM RIDES Company</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-5">
